...
namespace Lexicon.Common.DependencyInjection.ConfigurationSources;
public class ConfigurationInMemorySource : IEnumerable<KeyValuePair<string, string?>>
{
    ...
    public void Add(object? configuration)
    {
        if (configuration is not null)
        {
            ...
            KeyStringBuilder key = new KeyStringBuilder(configType.Name);
    ...
    {
        public static implicit operator string(KeyStringBuilder keyStringBuilder) => keyStringBuilder.ToString();
        ...
        public KeyStringBuilder Build(string path) => Build(new[] { path });
