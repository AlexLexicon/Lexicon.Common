...
public sealed class ToBooleanConverter : ValueConverterBase<bool>
{
    ...
    private static readonly ValueConverterParameterDefinition<IsStrings> FALSE_WHEN_STRING_PARAMETER = new ValueConverterParameterDefinition<IsStrings>("falsewhenstring", new ResultForPatternMatchCollection<IsStrings>
    {
    ...
    private bool GetResultFromObject(object? value, bool trueResult, bool falseResult)
    {
        ...
        if (value is string stringValue)
        {
            ...
            if (HasParameter(FALSE_WHEN_STRING_PARAMETER, out IsStrings isStringParameter))
            {
    ...
    private bool GetBooleanFromComparable(IComparable comparableValue, bool trueResult, bool falseResult)
    {
        return comparableValue.CompareTo(0) == 1 ? trueResult : falseResult;
    }
}